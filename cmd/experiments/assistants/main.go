...
import (
	"encoding/json"
	"fmt"
	"github.com/go-go-golems/geppetto/cmd/experiments/assistants/cmd/assistants"
	"github.com/go-go-golems/geppetto/cmd/experiments/assistants/cmd/files"
	"github.com/go-go-golems/geppetto/cmd/experiments/assistants/cmd/threads"
	assistants3 "github.com/go-go-golems/geppetto/pkg/openai/assistants"
...
func runAssistant(apiKey, threadID string, run assistants3.Run) (string, error) {
...
func createAssistant(apiKey string, assistant assistants3.Assistant) (string, error) {
...
func addMessageToThread(apiKey, threadID string, message assistants3.Message) (string, error) {
...
func oldMain() {
	...
	assistant := assistants3.Assistant{
		Name:         "Math Tutor",
	...
	message := assistants3.Message{
		ThreadID: threadID,
		Role:     "user",
		Content: []assistants3.ContentObject{
			{
				Type: "text",
				Text: &assistants3.TextContent{
