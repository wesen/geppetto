...
import (
	"context"
	"encoding/json"
	assistants2 "github.com/go-go-golems/geppetto/pkg/openai/assistants"
...
func (c *ModifyAssistantCommand) Run(
	...
	updateData := assistants2.Assistant{}
	...
	assistant, err := assistants2.ModifyAssistant(apiKey, assistantID, updateData)
	if err != nil {
		return err
	}
