...
import (
	"context"
	"fmt"
	"github.com/go-go-golems/geppetto/pkg/openai"
...
func (c *ListFilesCommand) Run(
	...
	filesResponse, err := openai.ListFiles(client, "https://api.openai.com/v1/", apiKey)
	if err != nil {
		return err
	}
...
func (c *CreateFileCommand) Run(
	...
	file, err := openai.CreateFile(client, "https://api.openai.com/v1/", apiKey, openai.CreateFileRequest{
		File:    fileContent,
		Purpose: purpose,
	})
	if err != nil {
...
func (c *DeleteFileCommand) Run(
	...
	deleteResponse, err := openai.DeleteFile(client, "https://api.openai.com/v1/", apiKey, fileID)
	if err != nil {
		return err
	}
